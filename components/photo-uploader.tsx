...
export function PhotoUploader({
  username,
  uploadServerUrl = "http://localhost:3001",
  onUploadComplete,
}: PhotoUploaderProps) {
        ...
        <div className="flex items-center gap-2">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={() => setFolderDialogOpen(true)}>+ Add new folder</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
      ...
      {files.length === 0 && (
        <div className="border border-dashed rounded-lg p-12 text-center">
          <div className="mx-auto flex flex-col items-center justify-center gap-1">
            ...
            <h3 className="mt-2 text-lg font-semibold">Drag photos here or click to browse</h3>
            <p className="text-sm text-muted-foreground">Supports JPG, PNG and GIF files</p>
